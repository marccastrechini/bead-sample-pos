...
android {
    namespace = "com.beadpay.samplepos"
    compileSdk = 35        // or 35 if installed

    defaultConfig {
        applicationId = "com.beadpay.samplepos"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    // composeOptions block is NO LONGER REQUIRED with Kotlin-2.0 + plugin
}
